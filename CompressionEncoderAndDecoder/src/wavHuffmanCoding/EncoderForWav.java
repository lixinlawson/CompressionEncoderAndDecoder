...
public class EncoderForWav extends JFrame {

	public EncoderForWav(boolean fileError) {

		super("Huffman Encoder For .wav");
	...
	private JButton createOpenFileButton(final EncoderForWav wavFileReader,
			final boolean fileError) {

		JButton openFile = new JButton("OPEN A WAV FILE");
	...
	private JPanel createErrorPanel() {
		...
		JLabel error = new JLabel(
				"ERROR: The file you selected is NOT a wav file !");
		JLabel msg = new JLabel("Only .wav or .WAV file can be selected !");
