...
public class ImagePanel extends JPanel {
	...
	public ImagePanel(TifFile tiffFile) {
		// constructor for .tiff file
		pixelData = tiffFile.getPixelData();
		width = tiffFile.getWidthOfImage();
		height = tiffFile.getHeightOfImage();
